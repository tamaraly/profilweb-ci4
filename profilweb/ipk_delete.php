...
// cek data post, jika ada id berarti proses delete
if (isset($_POST['id'])) {
    $id = $_POST['id'];
    ...
    if (pg_num_rows($data_db) > 0) {
        $data_db = pg_fetch_array($data_db, null, PGSQL_ASSOC);
        $id = $data_db['id'];
        $result = pg_query("DELETE FROM ipk WHERE id=$id");
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center" style="height: calc(100vh - 56px)">
            <div class="col-12 col-md-6 col-lg-4">
                <h1 class="display-4 mb-4">Hapus IPK</h1>
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="semester" name="semester" value="<?= $data_db['semester'] ?>" readonly required>
                            </div>
                            <div class="mb-4">
                                <label for="ipk" class="form-label">IPK</label>
                                <input type="text" class="form-control" id="ipk" name="ipk" value="<?= $data_db['ipk'] ?>" readonly required>
                            </div>
